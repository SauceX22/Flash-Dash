...
public class Path
{
    ...
    public Path(Vector2 centre, float scale)
    {
        points = new List<Vector2>
        {
            centre+Vector2.left * scale,
            centre+(Vector2.left+Vector2.up) * .5f * scale,
            centre + (Vector2.right+Vector2.down) *.5f * scale,
            centre + Vector2.right * scale
        };
    }
